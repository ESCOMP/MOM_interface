...
def diagnostics_to_diag_table(MARBL_diagnostics_in,
                              diag_table_out,
                              diag2D_list,
                              vert_grid,
                              lMARBL_output_all,
    ...
    for line in all_lines:
        ...
        for freq in frequency:
            ...
            if varname in processed_vars[freq]:
                logger.error(f"{varname} appears in {MARBL_diagnostics_in} with frequency %{freq} multiple times")
                sys.exit(1)
...
if __name__ == "__main__":
    ...
    diagnostics_to_diag_table(args.MARBL_diagnostics_in,
                              args.diag_table_out,
                              args.diag2D_list,
                              args.vert_grid,
